...
public class c_Strings {
    ...
    // //Largest String (lexicographical order)
    // public static void main(String args[]) {
    //     String str[] = {"apple", "mango", "banana", "carrot"};
    //     String largest = str[0];
    //     for (int i=1; i<str.length; i++) {
    //         if (largest.compareTo(str[i])  < 0) {  // (<0 largest is smaller), (0 both strings are equal), (>0 largest is bigger)
    //             largest = str[i];
    //         }
    //     }
