...
public class t_Hashing03 {
    ...
    //     //Largest Subarray with Sum 0 O(n) - (Their is an imp presum property which is used in this problem, check new notes for that)
    ...
    //             len = Math.max(len, i-hm.get(sum)); //len = j-i check lecture imp 
    //         }
    //         else{
    //             hm.put(sum, i);
    //         }
    ...
    //     System.out.println("Largest Subarray with Sum 0: " + len);
        ...
        // //Subarr Sum Equal to k (very imp, explain notes math equations very intuitive and dryrun must check lecture)
        // int arr[] = {10, 2, -2, -20, 10};
        // int k = -10;

        // HashMap<Integer, Integer> map = new HashMap<>();
        // map.put(0, 1); //check why this in lecture
        ...
        //IMPORTANT their is an imp problem called LRU cahched on LC check it.
